...
That observation was excluded because the fronds value for 2000-09-22 in transect 6, quad 40 is -99999, which is not an actual count but a code indicating missing or unrecorded data. The dataset documentation explains this in the Methods and Protocols tab on the data page, under the method's section.
